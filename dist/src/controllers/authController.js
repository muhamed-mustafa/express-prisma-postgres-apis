...
router.post('/users', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, auth_service_1.createUser)(req.body.user)];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
...
router.post('/users/login', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, auth_service_1.login)(req.body.user)];
            case 1:
                user = _a.sent();
                res.json({ user: user });
                return [3 /*break*/, 3];
...
router.get('/user', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, auth_service_1.getCurrentUser)(req.token)];
            case 1:
                user = _a.sent();
                res.json({ user: user });
                return [3 /*break*/, 3];
